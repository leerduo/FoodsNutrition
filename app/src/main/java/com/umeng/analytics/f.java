...
public final class f
{
  ...
  private String m()
  {
    return "mobclick_agent_cached_" + c + bi.a(b);
  }
  ...
  public byte[] b()
  {
    ...
    //   0	111	0	this	f
    //   4	41	1	str	String
    //   19	16	2	localFile	File
    //   86	5	3	localObject1	Object
    //   52	42	4	localFileInputStream1	java.io.FileInputStream
    //   91	8	5	localObject2	Object
    //   101	1	5	localObject3	Object
    //   69	6	6	localException1	Exception
    //   106	1	6	localException2	Exception
    //   48	3	7	localFileInputStream2	java.io.FileInputStream
    //   59	8	8	arrayOfByte	byte[]
    // Exception table:
    //   from	to	target	type
  ...
  public byte[] d()
  {
    ...
    //   0	126	0	this	f
    //   4	42	1	str	String
    //   19	53	2	localFile	File
    //   70	7	3	localException1	Exception
    //   31	3	5	l1	long
    //   105	1	7	localObject1	Object
    //   108	1	7	localObject2	Object
    //   118	1	7	localObject3	Object
    //   53	69	8	localFileInputStream1	java.io.FileInputStream
    //   82	6	9	localException2	Exception
    //   113	1	9	localException3	Exception
    //   49	3	10	localFileInputStream2	java.io.FileInputStream
    //   60	8	11	arrayOfByte	byte[]
    // Exception table:
    //   from	to	target	type
