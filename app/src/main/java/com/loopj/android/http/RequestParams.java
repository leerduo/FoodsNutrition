  ...
  implements Serializable
{
  ...
  private HttpEntity createJsonStreamerEntity(ResponseHandlerInterface paramResponseHandlerInterface)
  {
    ...
    while (localIterator4.hasNext())
    {
      ...
      RequestParams.StreamWrapper localStreamWrapper = (RequestParams.StreamWrapper)localEntry1.getValue();
      if (localStreamWrapper.inputStream != null) {
        localJsonStreamerEntity.addPart((String)localEntry1.getKey(), RequestParams.StreamWrapper.newInstance(localStreamWrapper.inputStream, localStreamWrapper.name, localStreamWrapper.contentType, localStreamWrapper.autoClose));
      }
    }
