  ...
  extends AsyncHttpResponseHandler
{
  ...
  byte[] getResponseData(org.apache.http.HttpEntity paramHttpEntity)
  {
    ...
    //   32: lcmp
    //   33: ifle +13 -> 46
    //   36: new 19	java/lang/IllegalArgumentException
    //   39: dup
    //   40: ldc 53
    //   42: invokespecial 56	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   45: athrow
    //   46: lload 4
    //   48: lconst_0
    //   49: lcmp
    ...
    //   53: ldc2_w 57
    //   56: lstore 4
    //   58: new 60	org/apache/http/util/ByteArrayBuffer
    //   61: dup
    //   62: lload 4
    //   64: l2i
    //   65: invokespecial 63	org/apache/http/util/ByteArrayBuffer:<init>	(I)V
    //   68: astore 6
    //   70: sipush 4096
    //   73: newarray byte
    //   75: astore 9
    //   77: aload_3
    //   78: aload 9
    //   80: invokevirtual 69	java/io/InputStream:read	([B)I
    //   83: istore 10
    //   85: iload 10
    //   87: iconst_m1
    //   88: if_icmpeq +61 -> 149
    //   91: invokestatic 75	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   94: invokevirtual 79	java/lang/Thread:isInterrupted	()Z
    //   97: ifne +52 -> 149
    //   100: aload 6
    //   102: aload 9
    //   104: iconst_0
    //   105: iload 10
    //   107: invokevirtual 83	org/apache/http/util/ByteArrayBuffer:append	([BII)V
    //   110: aload_0
    //   111: aload 9
    //   113: iconst_0
    //   114: iload 10
    //   116: invokestatic 85	com/loopj/android/http/DataAsyncHttpResponseHandler:copyOfRange	([BII)[B
    //   119: invokevirtual 89	com/loopj/android/http/DataAsyncHttpResponseHandler:sendProgressDataMessage	([B)V
    //   122: goto -45 -> 77
    //   125: astore 7
    //   127: aload_3
    //   128: invokestatic 95	com/loopj/android/http/AsyncHttpClient:silentCloseInputStream	(Ljava/io/InputStream;)V
    //   131: aload 7
    //   133: athrow
    //   134: astore 8
    //   136: invokestatic 98	java/lang/System:gc	()V
    //   139: new 100	java/io/IOException
    //   142: dup
    //   143: ldc 102
    //   145: invokespecial 103	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   148: athrow
    //   149: aload_3
    //   150: invokestatic 95	com/loopj/android/http/AsyncHttpClient:silentCloseInputStream	(Ljava/io/InputStream;)V
    //   153: aload 6
    //   155: invokevirtual 107	org/apache/http/util/ByteArrayBuffer:toByteArray	()[B
    //   158: astore 11
    //   160: aload 11
    //   162: astore_2
    //   163: aload_2
    ...
    //   134	1	8	localOutOfMemoryError	java.lang.OutOfMemoryError
