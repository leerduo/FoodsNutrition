...
public class Base64
{
  ...
  public static final byte[] decodeFast(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (int k = paramInt1; (k < j) && (IA[paramString.charAt(k)] < 0); k++) {}
    for (;;)
    {
      int m;
      if ((m > 0) && (IA[paramString.charAt(m)] < 0))
      {
        m--;
      }
      else
      {
        ...
        for (int i2 = i23 << 1;; i2 = 0)
        {
          ...
          while (i6 < i4)
          {
            int[] arrayOfInt2 = IA;
            int i14 = k + 1;
            int i15 = arrayOfInt2[paramString.charAt(k)] << 18;
            int[] arrayOfInt3 = IA;
            int i16 = i14 + 1;
            int i17 = i15 | arrayOfInt3[paramString.charAt(i14)] << 12;
            int[] arrayOfInt4 = IA;
            int i18 = i16 + 1;
            int i19 = i17 | arrayOfInt4[paramString.charAt(i16)] << 6;
            int[] arrayOfInt5 = IA;
            k = i18 + 1;
            int i20 = i19 | arrayOfInt5[paramString.charAt(i18)];
            int i21 = i6 + 1;
        ...
        if (i6 < i3)
        {
          ...
          while (i7 <= m - n)
          {
            int[] arrayOfInt1 = IA;
            int i12 = i7 + 1;
            int i13 = i8 | arrayOfInt1[paramString.charAt(i7)] << 18 - i * 6;
            i++;
            i8 = i13;
            i7 = i12;
          }
