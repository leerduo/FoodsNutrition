...
public final class ErrorCorrection
{
  ...
  private static String a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      {
        int n = arrayOfChar1[(paramInt3 - 1)] ^ paramCharSequence.charAt(m);
        int i1 = paramInt3 - 1;
        if (i1 > 0)
        {
          if ((n != 0) && (arrayOfInt[i1] != 0)) {
            arrayOfChar1[i1] = ((char)(arrayOfChar1[(i1 - 1)] ^ d[((c[n] + c[arrayOfInt[i1]]) % 255)]));
          }
          for (;;)
          {
            i1--;
            break;
            arrayOfChar1[i1] = arrayOfChar1[(i1 - 1)];
          }
        }
        if ((n != 0) && (arrayOfInt[0] != 0)) {
          arrayOfChar1[0] = ((char)d[((c[n] + c[arrayOfInt[0]]) % 255)]);
        }
        for (;;)
        {
          m++;
  ...
  public static String a(String paramString, SymbolInfo paramSymbolInfo)
  {
    if (paramString.length() != paramSymbolInfo.h()) {
      throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
    }
    StringBuilder localStringBuilder1 = new StringBuilder(paramSymbolInfo.h() + paramSymbolInfo.i());
    localStringBuilder1.append(paramString);
    int i = paramSymbolInfo.a();
    if (i == 1) {
      localStringBuilder1.append(a(paramString, paramSymbolInfo.i()));
    }
    for (;;)
    {
      ...
      for (int j = 0; j < i; j++)
      {
        arrayOfInt1[j] = paramSymbolInfo.a(j + 1);
        arrayOfInt2[j] = paramSymbolInfo.b(j + 1);
        arrayOfInt3[j] = 0;
        if (j > 0) {
      ...
      for (int k = 0; k < i; k++)
      {
        ...
        int m = k;
        while (m < paramSymbolInfo.h())
        {
          localStringBuilder2.append(paramString.charAt(m));
          m += i;
        }
        String str = a(localStringBuilder2.toString(), arrayOfInt2[k]);
        int n = k;
        int i3;
        for (int i1 = 0; n < i * arrayOfInt2[k]; i1 = i3)
        {
          int i2 = n + paramSymbolInfo.h();
          i3 = i1 + 1;
