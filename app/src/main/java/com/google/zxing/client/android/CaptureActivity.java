  ...
  implements SurfaceHolder.Callback
{
  ...
  private static final Collection<ResultMetadataType> c = EnumSet.of(ResultMetadataType.e, ResultMetadataType.f, ResultMetadataType.d, ResultMetadataType.g);
  ...
  private void a(Bitmap paramBitmap, float paramFloat, Result paramResult)
  {
    ...
    if ((arrayOfResultPoint != null) && (arrayOfResultPoint.length > 0))
    {
      ...
      localPaint.setColor(getResources().getColor(R.color.zxing_result_points));
  ...
  private void a(Bitmap paramBitmap, Result paramResult)
  {
    ...
    if (this.f != null)
    {
      Message localMessage = Message.obtain(this.e, R.id.zxing_decode_succeeded, this.f);
      this.e.sendMessage(localMessage);
    }
    this.f = null;
  }
  ...
  private void a(Result paramResult, Bitmap paramBitmap)
  {
    ...
    while (this.l == IntentSource.a)
    {
      ...
      if (localMap != null)
      {
        ...
        Number localNumber = (Number)localMap.get(ResultMetadataType.b);
        if (localNumber != null) {
      ...
      a(R.id.zxing_return_scan_result, localIntent, l1);
    }
  }
  ...
  private void f()
  {
    ...
    localBuilder.setTitle(getString(R.string.zxing_app_name));
    localBuilder.setMessage(getString(R.string.zxing_msg_camera_framework_bug));
  ...
  private void g()
  {
    ...
    this.h.setText(R.string.zxing_msg_default_status);
  ...
  {
    if (this.e != null) {
      this.e.sendEmptyMessageDelayed(R.id.zxing_restart_preview, paramLong);
    }
    g();
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    int i1 = R.layout.zxing_capture;
    if (localBundle != null) {
      i1 = localBundle.getInt("ZXING_CAPTURE_LAYOUT_ID_KEY", R.layout.zxing_capture);
    }
    setContentView(i1);
    this.k = false;
    ...
    this.t = ((Button)findViewById(R.id.zxing_back_button));
    if (this.t != null) {
  ...
  {
    getMenuInflater().inflate(R.menu.zxing_capture, paramMenu);
  ...
  public boolean onOptionsItemSelected(MenuItem paramMenuItem)
  {
    ...
    localIntent.addFlags(524288);
    if (paramMenuItem.getItemId() == R.id.zxing_menu_help)
    {
  ...
  protected void onResume()
  {
    ...
    this.i = findViewById(R.id.zxing_result_view);
    ...
    if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean("zxing_preferences_orientation", true))
    {
      ...
      g();
      localSurfaceHolder = ((SurfaceView)findViewById(R.id.zxing_preview_view)).getHolder();
      if (!this.k) {
        break label367;
      }
      ...
      if (localIntent != null)
      {
        ...
        {
          int i2 = localIntent.getIntExtra("SCAN_WIDTH", 0);
          int i3 = localIntent.getIntExtra("SCAN_HEIGHT", 0);
          if ((i2 > 0) && (i3 > 0)) {
            this.d.a(i2, i3);
          }
        }
        ...
        {
          int i1 = localIntent.getIntExtra("SCAN_CAMERA_ID", -1);
          if (i1 >= 0) {
            this.d.a(i1);
          }
        }
