  ...
  extends View
{
  ...
  public ViewfinderView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.e = localResources.getColor(R.color.zxing_viewfinder_mask);
    this.f = localResources.getColor(R.color.zxing_result_view);
    this.g = localResources.getColor(R.color.zxing_viewfinder_laser);
    this.h = localResources.getColor(R.color.zxing_possible_result_points);
    this.i = 0;
