  ...
  extends Handler
{
  ...
  private void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    //   3: lstore 4
    //   5: aload_0
    //   6: getfield 38	com/google/zxing/client/android/DecodeHandler:b	Lcom/google/zxing/client/android/CaptureActivity;
    //   9: invokevirtual 111	com/google/zxing/client/android/CaptureActivity:c	()Lcom/google/zxing/client/android/camera/CameraManager;
    //   12: aload_1
    //   13: iload_2
    //   14: iload_3
    //   15: invokevirtual 116	com/google/zxing/client/android/camera/CameraManager:a	([BII)Lcom/google/zxing/PlanarYUVLuminanceSource;
    //   18: astore 6
    //   20: aconst_null
    //   21: astore 7
    //   23: aload 6
    ...
    //   44: astore 8
    //   46: aload_0
    //   47: getfield 33	com/google/zxing/client/android/DecodeHandler:c	Lcom/google/zxing/MultiFormatReader;
    //   50: aload 8
    ...
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 33	com/google/zxing/client/android/DecodeHandler:c	Lcom/google/zxing/MultiFormatReader;
    //   65: invokevirtual 131	com/google/zxing/MultiFormatReader:a	()V
    //   68: aload_0
    //   69: getfield 38	com/google/zxing/client/android/DecodeHandler:b	Lcom/google/zxing/client/android/CaptureActivity;
    //   72: invokevirtual 134	com/google/zxing/client/android/CaptureActivity:b	()Landroid/os/Handler;
    //   75: astore 11
    //   77: aload 7
    //   79: ifnull +116 -> 195
    //   82: invokestatic 106	java/lang/System:currentTimeMillis	()J
    //   85: lstore 12
    //   87: getstatic 22	com/google/zxing/client/android/DecodeHandler:a	Ljava/lang/String;
    ...
    //   124: ifnull +43 -> 167
    //   127: aload 11
    //   129: getstatic 162	com/google/zxing/client/android/R$id:zxing_decode_succeeded	I
    //   132: aload 7
    ...
    //   148: aload 6
    //   150: aload 16
    //   152: invokestatic 171	com/google/zxing/client/android/DecodeHandler:a	(Lcom/google/zxing/PlanarYUVLuminanceSource;Landroid/os/Bundle;)V
    //   155: aload 15
    //   157: aload 16
    ...
    //   168: astore 10
    //   170: aload_0
    //   171: getfield 33	com/google/zxing/client/android/DecodeHandler:c	Lcom/google/zxing/MultiFormatReader;
    ...
    //   183: astore 9
    //   185: aload_0
    //   186: getfield 33	com/google/zxing/client/android/DecodeHandler:c	Lcom/google/zxing/MultiFormatReader;
    ...
    //   197: ifnull -30 -> 167
    //   200: aload 11
    //   202: getstatic 181	com/google/zxing/client/android/R$id:zxing_decode_failed	I
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      return;
      if (paramMessage.what == R.id.zxing_decode)
      {
        a((byte[])paramMessage.obj, paramMessage.arg1, paramMessage.arg2);
        return;
      }
    } while (paramMessage.what != R.id.zxing_quit);
    this.d = false;
