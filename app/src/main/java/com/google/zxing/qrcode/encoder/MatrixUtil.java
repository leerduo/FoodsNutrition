...
final class MatrixUtil
{
        ...
        while (i4 < 2)
        {
          ...
          else
          {
            ...
            if (i2 < paramBitArray.a())
            {
              ...
              bool1 = bool2;
              label125:
              if ((paramInt != -1) && (MaskUtil.a(paramInt, i5, n))) {
                if (bool1) {
                  break label176;
                }
              }
  ...
  static void a(ErrorCorrectionLevel paramErrorCorrectionLevel, int paramInt, BitArray paramBitArray)
  {
    ...
    int i = paramInt | paramErrorCorrectionLevel.a() << 3;
    paramBitArray.b(i, 5);
    paramBitArray.b(a(i, 1335), 10);
    BitArray localBitArray = new BitArray();
    localBitArray.b(21522, 15);
  ...
  {
    paramBitArray.b(paramVersion.a(), 6);
    paramBitArray.b(a(paramVersion.a(), 7973), 12);
