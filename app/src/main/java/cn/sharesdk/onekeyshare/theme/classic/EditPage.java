  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  private LinearLayout getAtLine(String paramString)
  {
    ...
    localLayoutParams1.rightMargin = R.dipToPx(getContext(), 4);
    ...
    localTextView1.setPadding(0, 0, 0, R.dipToPx(getContext(), 2));
    ...
    int k = R.getStringRes(this.activity, "list_friends");
  ...
  private TitleLayout getPageTitle()
  {
    ...
    int j = R.getStringRes(this.activity, "share");
    if (j > 0) {
  ...
  private Bitmap getPlatLogo(Platform paramPlatform)
  {
    ...
    do
    {
      ...
      i = R.getBitmapRes(this.activity, str);
    } while (i <= 0);
  ...
  private RelativeLayout getThumbView()
  {
    ...
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(R.dipToPx(getContext(), 82), R.dipToPx(getContext(), 98));
    ...
    int j = R.dipToPx(getContext(), 4);
    this.ivImage.setPadding(j, j, j, j);
    int k = R.dipToPx(getContext(), 74);
    RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(k, k);
    localLayoutParams1.setMargins(0, R.dipToPx(getContext(), 16), R.dipToPx(getContext(), 8), 0);
    ...
    int m = R.getBitmapRes(this.activity, "img_cancel");
    if (m > 0) {
      localButton.setBackgroundResource(m);
    }
    int n = R.dipToPx(getContext(), 20);
  ...
  public void afterPlatformListGot()
  {
    ...
    for (int i2 = m;; i2 = i1)
    {
      ...
      break;
      label332:
      this.views[m].setLayoutParams(localLayoutParams1);
      localFrameLayout.addView(this.views[m]);
      m++;
      n = i1;
      break label81;
      label366:
      UIHandler.sendEmptyMessageDelayed(0, 333L, new EditPage.6(this, n, j, k));
      return;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    label213:
    label253:
    for (Platform localPlatform = this.platformList[i];; localPlatform = null)
    {
      ...
      do
      {
        ...
        k = R.getStringRes(this.activity, "select_one_plat_at_least");
      } while (k <= 0);
