...
public class ShareCore
{
  ...
  {
    return (!"WechatMoments".equals(paramString)) && (!"WechatFavorite".equals(paramString)) && (!"ShortMessage".equals(paramString)) && (!"Email".equals(paramString)) && (!"GooglePlus".equals(paramString)) && (!"Pinterest".equals(paramString)) && (!"Yixin".equals(paramString)) && (!"YixinMoments".equals(paramString)) && (!"Line".equals(paramString)) && (!"KakaoStory".equals(paramString)) && (!"KakaoTalk".equals(paramString)) && (!"Bluetooth".equals(paramString)) && (!"WhatsApp".equals(paramString));
  }
  ...
  public boolean share(Platform paramPlatform, HashMap<String, Object> paramHashMap)
  {
    ...
    try
    {
      ...
      {
        File localFile = new File(R.getCachePath(paramPlatform.getContext(), "screenshot"), String.valueOf(System.currentTimeMillis()) + ".jpg");
