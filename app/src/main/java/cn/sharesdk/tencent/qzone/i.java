  ...
  extends FakeActivity
{
  ...
  private void b(String paramString)
  {
    ...
    this.g = true;
    finish();
    this.c.onComplete(null, 0, new d().a(str4));
  }
  ...
  private void d()
  {
    ...
    try
    {
      int j = R.getStringRes(getContext(), "share_to_qzone");
      if (j > 0) {
      ...
      if ("none".equals(b.a(this.activity).n()))
      {
        this.h = true;
        finish();
  ...
  public void onCreate()
  {
    ...
    {
      finish();
      Bundle localBundle = R.urlToBundle(localIntent.getDataString());
      ...
      if (("shareToQQ".equals(str3)) || ("shareToQzone".equals(str3)))
      {
        ...
        if (this.c != null)
        {
          ...
          HashMap localHashMap = new d().a(str4);
