...
public class k
{
  ...
  public void a(WechatResp paramWechatResp)
  {
    ...
    default: 
      ...
      new Throwable(new d().a(localHashMap4)).printStackTrace();
    }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localThrowable2 = new Throwable(new d().a(localHashMap2));
          switch (paramWechatResp.a())
          {
          default: 
            return;
      ...
      localThrowable1 = new Throwable(new d().a(localHashMap1));
      switch (paramWechatResp.a())
      {
      default: 
        return;
